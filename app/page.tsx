  ...
  return (
    <header className="sticky top-0 z-50 border-b border-zinc-100 bg-white/95 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between gap-6">
        ...
        {/* Wordmark */}
        <Link href="/" className="flex items-center gap-2.5 group shrink-0" aria-label="Kesher home">
        ...
        {/* Nav right: Sign In + Demo */}
        <div className="flex items-center gap-2 shrink-0">
          <Link
            href="/login"
            className="inline-flex items-center px-3.5 py-1.5 text-[13px] font-medium text-zinc-500 hover:text-zinc-900 transition-colors"
          >
            Sign in
          </Link>
          <a
            href={DEMO_MAILTO}
            className="inline-flex items-center gap-1.5 rounded-md bg-[#0f0f0f] px-3.5 py-1.5 text-[13px] font-medium text-white hover:bg-zinc-700 transition-colors"
          >
            Request a demo
