  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-12">
        ...
        <div className="prose prose-sm max-w-none text-zinc-700 space-y-8">

          {/* 1. Introduction */}
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">1. About This Policy</h2>
            <p>
          ...
          <section>
            ...
            <h3 className="text-sm font-semibold text-zinc-800 mb-2">From School Administrators</h3>
            ...
            <h3 className="text-sm font-semibold text-zinc-800 mt-4 mb-2">From School Community Members (Recipients)</h3>
            <p className="text-sm">
            ...
            <h3 className="text-sm font-semibold text-zinc-800 mt-4 mb-2">Automatically Collected Information</h3>
            <ul className="list-disc list-inside space-y-1 text-sm">
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">3. How We Use Your Information</h2>
            <ul className="list-disc list-inside space-y-1 text-sm">
          ...
          <section className="border border-zinc-200 rounded-lg p-5 bg-zinc-50">
            <h2 className="text-base font-semibold text-zinc-900 mb-3">4. SMS Text Messaging Program</h2>

            <h3 className="text-sm font-semibold text-zinc-800 mb-2">Program Description</h3>
            <p className="text-sm">
            ...
            <h3 className="text-sm font-semibold text-zinc-800 mt-4 mb-2">SMS Consent</h3>
            <p className="text-sm">
            ...
            <h3 className="text-sm font-semibold text-zinc-800 mt-4 mb-2">Message and Data Rates</h3>
            <p className="text-sm">
              Message and data rates may apply. Contact your mobile carrier for details.
            </p>

            <h3 className="text-sm font-semibold text-zinc-800 mt-4 mb-2">How to Opt Out of SMS</h3>
            <p className="text-sm">
            ...
            <h3 className="text-sm font-semibold text-zinc-800 mt-4 mb-2">SMS Data — Sharing Restrictions</h3>
            ...
            <h3 className="text-sm font-semibold text-zinc-800 mt-4 mb-2">Supported Keywords</h3>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">5. How We Share Information</h2>
          ...
          {/* 6. FERPA */}
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">6. Student Data and FERPA</h2>
            <p className="text-sm">
          ...
          {/* 7. Data Security */}
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">7. Data Security</h2>
            <p className="text-sm">
          ...
          {/* 8. Data Retention */}
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">8. Data Retention</h2>
            <p className="text-sm">
          ...
          {/* 9. Your Rights */}
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">9. Your Rights</h2>
          ...
          {/* 10. Children */}
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">10. Children's Privacy</h2>
            <p className="text-sm">
          ...
          {/* 11. Changes */}
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">11. Changes to This Policy</h2>
            <p className="text-sm">
          ...
          {/* 12. Contact */}
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-3">12. Contact Us</h2>
            <p className="text-sm">
            ...
            <p className="text-sm mt-3">
              ...
              <a href={`mailto:${CONTACT_EMAIL}`} className="underline">{CONTACT_EMAIL}</a> with
              your phone number and the school name.
            </p>
          </section>
